...
namespace uICAL
{
    ...
    const char *_logging_level_str(_logging_level level)
    {
        switch (level)
        {
        case _logging_level::trace:
            return "T";
        case _logging_level::debug:
            return "D";
        case _logging_level::info:
            return "I";
        case _logging_level::warning:
            return "W";
        case _logging_level::error:
            return "E";
        case _logging_level::metric:
            return "M";
        default:
            return "?";
        }
